...
### Rodando o projeto
Primeiro, instale as dependências do projeto raiz seguindo as orientações presentes no README de lá. Após a conclusão, retorne para este projeto App. Neste momento do projeto DS, caso queira visualizar os componentes, altere o conteúdo de *src/App.tsx* para algo semelhante à:
...
Isso fará com que a build do projeto seja feita em seu emulador Android, de acordo com seu ambiente de desenvolvimento. Também abrirá um metro bundler, mas *você deve encerrá-lo* e dar um comando para iniciar um novo metro bundler: `npx react-native start`. Suspeitamos que o primeiro metro aberto falhe pois tente iniciar o bundle referenciando o local errado, sem passar pelas alterações que realizamos na seção *Android* 
...
### Metro
Também alteramos o arquivo *metro.config* para apontar para os locais corretos;
```
