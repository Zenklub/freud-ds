...
import { Basic, Sort, BGColor, CaptionAndSummary } from './Table.stories.ts';
...
<Meta
  ...
  title="@freud-ds/web-components/Others/Table"
  component={FreudTableComponent}
/>
...
<freud-table [value]="value" [columns]="columns">
  <ng-template freudTemplate="header" let-columns="columns">
    <tr>
      <th freudSortableColumn="{{col}}" *ngFor="let col of columns">
        {{col}} <freud-sortIcon field="{{col}}"></freud-sortIcon>
      </th>
    </tr>
  </ng-template>
</freud-table>
...
<ArgTypes of={FreudTableComponent} />
