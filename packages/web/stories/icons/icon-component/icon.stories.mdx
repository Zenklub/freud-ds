...
import { FreudIconComponent, FreudIconModule, FreudIconSizes} from "@freud-ds/web-components";
import { FreudHeaderComponent } from "../../header/header.component";
import { Icon, IconSmall, IconTest } from "./Icon.stories";
...
como parâmetro. Para ver a lista de ícones disponíveis, [clique aqui][all-icons].
...
[all-icons]: https://zenklub.github.io/freud-ds/iframe.html?viewMode=docs&id=freud-ds-web-components-icons--storyname-hidden#a-idlistalisting
